...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupData(List<Tweet> data) {
        txtTweets.setText(TweetFormatter.formatTweets(data));
    }
    ...
    public void onTweet() {
        ...
        DatabaseManager.getInstance().sendTextTweet(tweet, email, new DatabaseManager.DataListener<String>() {
            ...
            public void onDataReady(String data) {
                Toast.makeText(MainActivity.this, "Tweet sent!", Toast.LENGTH_SHORT).show();
                getAndSetupData();
            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == REQUEST_CODE) {
            ...
            DatabaseManager.getInstance().sendPhotoTweet(this, imageBitmap, LoginManager.getInstance().getUserEmail(), new DatabaseManager.DataListener<String>() {
                @Override
                public void onDataReady(String data) {
                    Toast.makeText(MainActivity.this, "Photo tweeted", Toast.LENGTH_SHORT).show();
                    getAndSetupData();
                }

                @Override
                public void onError() {
                    Toast.makeText(MainActivity.this, "Photo failed", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
